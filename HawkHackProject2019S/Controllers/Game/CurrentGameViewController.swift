...
//                p1MoveResult = (damage:0, damageMultiplier:1, defenseMultiplier:1, speed:0)
//                p2MoveResult = (damage:0, damageMultiplier:1, defenseMultiplier:1, speed:0)
                let player1MoveTag = player1TagSelected.move == nil ? 1 : player1TagSelected.move //if p2MovrTsg is nil then move tag will be 1
                let player1AttackTag = player1TagSelected.attack == nil ? 1 : player1TagSelected.attack //edit this
...
//                if opponentTag != (1, 1) {
//                    print("Opponent P2 Tag is = \(opponentTag)")
//                    //                if opponentTag == (nil, nil) {
//                    //                    self.scheduledTimerWithTimeInterval()
//                    //                } else {
//                    //                    self.fetchingOpponentMoveTimer?.invalidate()
//                    let opponentSelectedMoveTag = opponentTag.0 == 1 ? nil : opponentTag.0 //if fetched opponentMove tag is == 1 then it is actually nil because we called that uploadTag that is nil will have a tag value of 1 instead
...
//
//                    self.applyDamagesToViews(opponentTag: (opponentSelectedMoveTag, opponentSelectedAttackTag), completion: {
//                        //                        player2TagSelected
//                        print("applyied damage to views")
//                        self.startTurnTimer()
//                    })
//                    //                }
//                }
...
//                if opponentTag != (1,1) {
//
//                    print("Opponent P1 Tag is = \(opponentTag)")
//                    //                    if opponentTag == (nil, nil) {
//                    //                        self.scheduledTimerWithTimeInterval()
//                    //                    } else {
//                    //                        self.fetchingOpponentMoveTimer?.invalidate()
...
//
//                    print("applying damage to views")
//                    self.applyDamagesToViews(opponentTag: (opponentSelectedMoveTag, opponentSelectedAttackTag)) {
...
//        var opponentMove: Int = 1
//        var opponentAttack: Int = 1
...
//                let opponentSelectedMoveTag = fetchedOpponentMove == 1 ? nil : fetchedOpponentMove
//                let opponentSelectedAttackTag = fetchedOpponentAttack == 1 ? nil : fetchedOpponentAttack
                ...
                if p1OrP2String == "p1" {
                    ...
                    for button in self.player1AttackButtons! where self.player1TagSelected.attack == button.buttonTag {
                        ...
                        print("Selected button is = \(button.buttonTag)")
                    }
...
//                opponentMove = fetchedOpponentMove
//                opponentAttack = fetchedOpponentAttack
...
//        print("fetched opponent move returning \((opponentMove, opponentAttack))")
...
//MARK: Helpers -----------------------------------------------------
	@objc func updateTurnTime() {
		...
		if clockCounter == 0 {
			...
			setupSelectedTag()
//            if isAgainstOnlineUser {
//                if player1TagSelected == (nil, nil) || player2TagSelected == (nil, nil) {
//                    print("Player1 or Player 2 Tag is nil")
//                } else {
//                    DispatchQueue.main.asyncAfter(deadline: .now() + 2) {
//                        self.finishTurn()
...
//            }
    ...
    private func finishTurn() {
        DispatchQueue.main.async {
            ...
            self.p1MoveResult = (damage:0, damageMultiplier:1, defenseMultiplier:1, speed:0)
            self.p2MoveResult = (damage:0, damageMultiplier:1, defenseMultiplier:1, speed:0)
...
/*
 ...
 let opponentTag = fetchOpponentSelectedTag(gameSessionId: game!.gameId, p1OrP2String: "p2", turnCount: turnCount)
 print("Opponent P2 Tag is = \(opponentTag)")
 //                if opponentTag == (nil, nil) {
 //                    self.scheduledTimerWithTimeInterval()
 //                } else {
 ...
 //                fetchOpponentSelectedTag(gameSessionId: game!.gameId, p1OrP2String: "p1", turnCount: turnCount) { (opponentTag) in
 let opponentTag = fetchOpponentSelectedTag(gameSessionId: game!.gameId, p1OrP2String: "p1", turnCount: turnCount)
 print("Opponent P1 Tag is = \(opponentTag)")
 //                    if opponentTag == (nil, nil) {
 //                        self.scheduledTimerWithTimeInterval()
 //                    } else {
 ...
 func fetchOpponentSelectedTag(gameSessionId: String, p1OrP2String: String, turnCount: Int) -> (Int, Int) {
 let ref =  firDatabase.child(kGAMESESSIONS).child(gameSessionId).child("currentGame").child("\(turnCount)")
 var opponentMove: Int = 1
 var opponentAttack: Int = 1
 ...
 print("fetched opponent move returning \((opponentMove, opponentAttack))")
 return (opponentMove, opponentAttack)
 }
